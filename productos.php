...
<body>
    ...
    <ul id="slide-out" class="side-nav">
        ...
        ?>
            ...
            <li class="activo"><a class="waves-effect" href="productos.php"><i class="material-icons left">dashboard</i>Productos</a></li><hr>
            <?php 
                if(isset($_SESSION['user'])){}
                else{
        ...
        <nav>
            <div class="nav-wrapper grey darken-3 z-depth-2">
                ...
                <ul class="right hide-on-med-and-down">
                    <li class="nav-menu"><a href="#"><i class="material-icons left">home</i>Inicio</a></li>
                    <li class="nav-menu activo"><a href="productos.php"><i class="material-icons left">dashboard</i>Productos</a></li>
                    <?php 
                        if(isset($_SESSION['user'])){
